<%-- 
    Document   : user_reg_process
    Created on : Dec 4, 2016, 7:57:04 AM
    Author     : user
--%>
...
String str="insert into user_reg(name,age,username,psd,dob,gender,addre_line1,addre_line2,state,country,email,phone,doj) values(?,?,?,?,?,?,?,?,?,?,?,?,?)";
