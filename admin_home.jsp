<%-- 
    Document   : admin_home
    Created on : Nov 28, 2016, 11:42:23 PM
    Author     : 4
--%>

<%-- 
    Document   : user_add_products
    Created on : Dec 13, 2016, 9:57:36 PM
    Author     : user
--%>
...
<div id="main_container">
  ...
  <div id="main_content">
    <div id="menu_tab">
      ...
      <ul class="menu">
        <li><a href="admin_home.jsp" class="nav1"> Home</a></li>
        <li class="divider"></li>
        <li><a href="category.jsp" class="nav2">Category</a></li>
        <li class="divider"></li>
