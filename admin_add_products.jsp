<%-- 
    Document   : admin_add_products
    Created on : Dec 13, 2016, 10:48:46 PM
    Author     : user
--%>
...
<div id="main_container">
  ...
  <div id="main_content">
    ...
    <h1>ADMIN ADD PRODUCTS</h1>
        ...
        <div>
            <form action="admin_add_products_process.jsp" method="post" enctype="multipart/form-data">
               <table border="1">
                  <tr> 
                 <td>CATEGORY</td>
                 <td>
                 ...
                 <td><input type="text" name="pro_name" required=""></td>
                  ...
                  <tr> 
                 <td>PRODUCT MODEL</td>
                 <td><input type="text" name="pro_model" required=""></td>
                 </tr>
                  <tr>      
                 <td>DESCRIPTION</td>
                 ...
                 <tr>
                <td>RATE</td>
                 <td><input type="text" name="pro_rate" required=""></td>
                 </tr>
                 <tr>
                 <td>DATE OF REGISTRATION</td>
                 <td><input type="date" name="dor" required="" min="2016-12-01" max="2999-12-31"></td>
                 </tr>
                 <tr>
